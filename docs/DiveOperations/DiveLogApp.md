...
!!! warning
    This guide reflects the updated Dive Log app following migration. The correct link is [https://sea-saba-self.vercel.app/](https://sea-saba-self.vercel.app/). Please disregard old links.
...
2. **Update your information**: Name, password, and preferred units.
3. **Check your role**: If it shows **"viewer"**, you will not be able to use the app — notify an admin to update your role.
4. **Units**: The app defaults to metric but will convert values to imperial if selected.
...
1. **Navigate to Dive Log**: From the home page, click **Dive Log — Log a Dive** in the navbar, or use the **Dive Log** link on the home page.
2. **Complete the form**: Fill out the multi-step form to log your dive and sightings.
3. **Review before submitting**: Check your entry on the confirmation screen.

!!! note
    If you see **NaN** (Not a Number) in a numeric field (e.g., temperature or depth), simply type over it with the correct value.

![Logging a Dive](../Images/DiveLog/LogADive.png)  

## Viewing Previous Entries

1. **Navigate to View Dives**: From the home page, click **Dive Log — View Dives** in the navbar, or use the **View Dives** link on the home page.
2. **Sort entries**: By boat, dive site, dive guide, or species.
3. **View sightings**: Click the **Sightings** button to view species recorded for a dive.
4. **Edit entries**: Update dive information or edit sightings as necessary. Only admins or the user who created the entry can make edits.

!!! warning
    Delete an entry only if entered in error. Deletions are irreversible.
...
!!! warning
    All dives must be logged by the **end of each day**.
