# Vessel Clearance with Sailclear
...
This SOP applies to employees assigned the task of clearing vessels.
...
3. **Crew and passenger manifest**: Follow the same process as the arrival notification.
4. **Complete the customs declaration**.
5. **Note the notification ID**: Use this to obtain clearance from customs.

![Departure Notification Example](../Images/Sailclear/depart.png)

## Accountability

Employees assigned to vessel clearance are responsible for following this SOP. Report any issues with the Sailclear system to management immediately.